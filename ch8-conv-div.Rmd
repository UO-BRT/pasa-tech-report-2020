---
title: "Chapter 8: Convergent/Divergent Validity"
author: "BRT"
...
ela_math_contingency %>%
  ...
  kable(., digits = 2, booktabs = TRUE,
        caption = "ELA - Math Performance Levels Chi-squared Test of Independence by Grade and Tier") %>% 
  kable_styling(full_width = TRUE)
```
...
pwalk(list(ela_math_cont_tables$Grade, ela_math_cont_tables$Tier, ela_math_cont_tables$tables), ~{ 
  cat("\n",
...
ela_science_contingency %>%
  ...
  mutate(`p-value` = ifelse(`p-value` < .01, "< .01", `p-value`)) %>% 
  kable(., digits = 2, booktabs = TRUE,
        caption = "ELA - Science Performance Levels Chi-squared Test of Independence by Grade and Tier") %>% 
  kable_styling(full_width = TRUE)
```
...
pwalk(list(ela_science_cont_tables$Grade, ela_science_cont_tables$Tier, ela_science_cont_tables$tables), ~{ 
  cat("\n",
      paste("#### Grade", ..1, "Tier", ..2),
      sep = "\n")
  print(..3)
...
math_science_contingency %>%
  ...
  mutate(`p-value` = ifelse(`p-value` < .01, "< .01", `p-value`)) %>% 
  kable(., digits = 2, booktabs = TRUE,
        caption = "Math - Science Performance Levels Chi-squared Test of Independence by Grade and Tier") %>% 
  kable_styling(full_width = TRUE)
```
