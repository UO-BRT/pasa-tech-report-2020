...
Item parameters and fit statistics are summariazed by content area, grade, and tier for all PASA tests in the tables, below. RMSEA, the root mean square error of approximation, offers an indication of item fit to the two-parameter logistic (2PL) IRT models used in scaling ELA and Math, and the one-parameter logistic (2PL) IRT model with guessing parameter used in scaling Science. For RMSEA, values of 0.01, 0.05 and 0.08 indicate excellent, good, and mediocre fit, respectively. RMSEA item fit statistics are summariazed for each ELA test as follows:

- **Grade 3, Tier 1:** *Range* = 0.00 to 0.06; *M* = 0.017
- **Grade 3, Tier 2:** *Range* = 0.00 to 0.14; *M* = 0.045; items E03AV4.1.1a.10, E03AV4.1.1b.4, and E03AV4.1.2a.7 exhibited poor fit, RMSEA ≥ 0.13; the fit of item E03C1.3.1a.2 was not estimable
- **Grade 4, Tier 1:** *Range* = 0.00 to 0.04; *M* = 0.015
- **Grade 4, Tier 2:** *Range* = 0.00 to 0.06; *M* = 0.017
- **Grade 5, Tier 1:** *Range* = 0.00 to 0.08; *M* = 0.014
...
- **Grade 7, Tier 1:** *Range* = 0.00 to 0.13; *M* = 0.025; item E07AK1.1.1c.3 exhibited poor fit, RMSEA = 0.13
- **Grade 7, Tier 2:** *Range* = 0.00 to 0.09; *M* = 0.025; items E07AK1.1.1a.8 and E07AV4.1.1a.9 exhibited poor fit, RMSEA = 0.09
- **Grade 8, Tier 1:** *Range* = 0.00 to 0.08; *M* = 0.020
...
RMSEA item fit statistics are summariazed for each Math test as follows:

- **Grade 3, Tier 1:** *Range* = 0.00 to 0.04; *M* = 0.018
- **Grade 3, Tier 2:** *Range* = 0.00 to 0.09; *M* = 0.037; item EM03DM1.2.1a.5 exhibited poor fit, RMSEA = 0.09
- **Grade 4, Tier 1:** *Range* = 0.00 to 0.04; *M* = 0.017
- **Grade 4, Tier 2:** *Range* = 0.00 to 0.18; *M* = 0.038; items M04AT1.1.3a.2 and M04CG1.1.2a.6 exhibited poor fit, RMSEA = 0.18 and 0.11, respectively
...
- **Grade 6, Tier 2:** *Range* = 0.00 to 0.12; *M* = 0.026; item M06AR112a_2019.1 exhibited poor fit
- **Grade 7, Tier 1:** *Range* = 0.00 to 0.07; *M* = 0.027
- **Grade 7, Tier 2:** *Range* = 0.00 to 0.07; *M* = 0.020
- **Grade 8, Tier 1:** *Range* = 0.00 to 0.12; *M* = 0.028; item M08BF2.1.1a.22 exhibited poor fit
- **Grade 8, Tier 2:** *Range* = 0.00 to 0.05; *M* = 0.015
- **Grade 11, Tier 1:** *Range* = 0.00 to 0.08; *M* = 0.027
- **Grade 11, Tier 2:** *Range* = 0.00 to 0.07; *M* = 0.013; the fit of items CC.2.3.HSA13a.15 and CC23HSA13a_2019.1 were not estimable
...
RMSEA item fit statistics are summariazed for each Science test as follows:

- **Grade 4, Tier 1:** *Range* = 0.00 to 0.10; *M* = 0.039; item S4.B.1.1.4.4 exhibited poor fit, RMSEA = 0.10
- **Grade 4, Tier 2:** *Range* = 0.00 to 0.15; *M* = 0.033; items S4.A.2.2.1.4 and S4.D.1.2.2.3 exhibited poor fit, RMSEA = 0.10 and 0.15, respectively
- **Grade 8, Tier 1:** *Range* = 0.00 to 0.08; *M* = 0.035
- **Grade 8, Tier 2:** *Range* = 0.00 to 0.12; *M* = 0.032; items S8.A.2.2.1.6, S8.B.1.1.3.5, and S8.C.2.2.3.6 exhibited poor fit, RMSEA = 0.10, 0.10, and 0.12, respectively
- **Grade 11, Tier 1:** *Range* = 0.00 to 0.12; *M* = 0.049; items S11.A.2.1.3.6, S11.B.3.1.4a.2, S11.B.3.1.4b.11, and S11.B.3.1.4b.9 exhibited poor fit, RMSEA = ≥ 0.09
- **Grade 11, Tier 2:** *Range* = 0.00 to 0.06; *M* = 0.023; the fit of item S11.B.1.1.2.6 was not estimable
