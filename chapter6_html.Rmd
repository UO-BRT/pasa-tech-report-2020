---
title: "Chapter 6"
subtitle: "Validity Based on Relations Among Content Areas"
author: "BRT"
date: "`r Sys.Date()`"
...
ela <- read_csv("W:/datastore/2020PASA_ScalingAnalysis/scoring-files-2020/Scoring_ELA_Final_2020.csv") %>% 
  clean_names()

math <- read_csv("W:/datastore/2020PASA_ScalingAnalysis/scoring-files-2020/Scoring_Math_Final_2020.csv") %>% 
  clean_names()

science <- read_csv("W:/datastore/2020PASA_ScalingAnalysis/scoring-files-2020/Scoring_Science_Final_2020.csv") %>% 
  clean_names()

demos <- rio::import("W:/datastore/2020PASA_ScalingAnalysis/Assessment Scoring 2020/Assessment_Scoring_Data_ELA_final.xlsx") %>%
  as_tibble() %>%
  clean_names() %>% 
